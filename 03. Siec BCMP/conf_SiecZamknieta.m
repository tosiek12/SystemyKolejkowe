...
siec = Network_nClass(3, 3, 'close');

%% Opis Stacji:
%Typy stacji (1/2/3/4)
siec.stations_types = [1; 2; 3];
%Ilosc kanalow obslugi
siec.stations_m = [2; 1; 1];
%Wspolczynnik obslugi zgloszen w stacjach dla ka¿dej z klas
siec.stations_Mi{1} = [1/0.2; 1/0.4; 1];
siec.stations_Mi{2} = [1/3; 1; 1/22];
siec.stations_Mi{3} = [1/3; 1; 1/22];
